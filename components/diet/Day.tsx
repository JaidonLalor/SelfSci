...
import FoodEntryEditor from './FoodEditor/FoodEntryEditor'
        ...
        <Screen>
            <View style={styles.header} >
                ...
                <View style={styles.headerLinkRightCol} >
                    ...
                    <Pressable onPress={() => router.push('/diet/presets')}>
            ...
            <View style={globalStyles.content}>
                ...
                >
                    ...
                    <View style={styles.entriesContainer}>
                        ...
                        {todaysSortedFoods
                            && todaysSortedFoods.map((food, index) => {
